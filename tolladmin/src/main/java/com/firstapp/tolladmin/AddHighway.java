...
public class AddHighway extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_highway);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Way h=new Way(id,way.getText().toString());

                databaseReference.child(id).setValue(h);
            }
        });
    }
